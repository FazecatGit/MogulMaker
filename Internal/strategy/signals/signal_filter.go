...
func GenerateValidationReport(signal *types.TradeSignal, filters ...func(*types.TradeSignal) ValidationCheck) *SignalValidationReport {
...
func ValidateMinimumConfidence(minThreshold float64) func(*types.TradeSignal) ValidationCheck {
	return func(signal *types.TradeSignal) ValidationCheck {
...
func ValidateMaximumConfidence(maxThreshold float64) func(*types.TradeSignal) ValidationCheck {
	return func(signal *types.TradeSignal) ValidationCheck {
		return ValidationCheck{
...
func ValidateDirection() func(*types.TradeSignal) ValidationCheck {
	return func(signal *types.TradeSignal) ValidationCheck {
...
func ValidateReasoning() func(*types.TradeSignal) ValidationCheck {
	return func(signal *types.TradeSignal) ValidationCheck {
		return ValidationCheck{
			Name:     "Has Reasoning",
